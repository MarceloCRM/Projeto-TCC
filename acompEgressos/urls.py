"""
URL configuration for acompEgressos project.
...
urlpatterns = [
    ...
    path('', RedirectView.as_view(pattern_name='estatistica:index', permanent=False)),
    path('curso/', include('apps.curso.urls', namespace='curso')),
