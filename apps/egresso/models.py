...
class Egresso(models.Model):
    ...
    situacao_profissional = models.CharField('Situação Profissional', max_length=20, choices=SITUACAO_PROFISSIONAL, default='desempregado',)
    empresa_atual = models.CharField('Empresa Atual', max_length=255, blank=True, null=True)
    faixa_salarial = models.CharField('Faixa Salarial', max_length=20, choices=FAIXA_SALARIAL, blank=True, null=True,)
